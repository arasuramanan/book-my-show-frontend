        ...
        />
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
                ...
                <Typography sx={{fontSize:"14px",fontWeight:500}} onClick={() => navigate('/bookmyshow/movies/admin')}>Movies</Typography>
                  <Typography sx={{fontSize:"14px",fontWeight:500}} onClick={() => navigate('/bookmyshow/movies/add')}>Add Movies</Typography>
                  {
